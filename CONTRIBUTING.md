...
Discussion around _exercises-scalatutorial_ happens in the [GitHub issues](https://github.com/scala-exercises/exercises-scalatutorial/issues) and [pull requests](https://github.com/scala-exercises/exercises-scalatutorial/pulls).
...
_exercises-scalatutorial_ follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
